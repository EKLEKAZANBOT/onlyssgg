...
exports.run = async (client, message, args) => {
  let çarpı = client.emojis.get("654344235620892682")
  if (message.author.id !== '338657065645899778') return message.channel.send(çarpı + " Bu komutu sadece `Yapımcım` **kullanabilir!**")
  let nesne = args[0]
  let çarpı2 = client.emojis.get("654344235620892682")
